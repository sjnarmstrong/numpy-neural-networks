...
for dataset, datasetHiddenLayers in zip(datasets, hiddenLayers):
    ...
    for currentHiddenLayer in datasetHiddenLayers:
        ...
        for Trial in range(NumTrials):   
            ...
            CrossOverClass=GA.allCombos(PopulationSize, chromesoneLen)
            MutationClass=GA.DampedMutation(PopulationSize, chromesoneLen, ceil(PopulationSize*chromesoneLen*5/100), 1, 0.998,0.05)
            ga=GA.GeneticAlgorithmMatrix(seeds, BNN.getBatchError, GA.TopN, CrossOverClass, MutationClass)
